...
<html dir="ltr">
  <head>
	...
	<?php else :?>
    	<script type="text/javascript" src="<?php echo plugin_dir_url(__FILE__);?>js/pdf-flipbook.min.js"/>
    <?php endif;?>    
    <?php 
      ...
      <div id="sidebarContainer">
        <div id="toolbarSidebar">
          <div class="splitToolbarButton toggled">
            <button id="viewThumbnail" class="toolbarButton toggled" title="Afficher les vignettes" onclick="PDFView.switchSidebarView('thumbs')" tabindex="1" data-l10n-id="thumbs" style="display:none;">
               <span data-l10n-id="thumbs_label">Vignettes</span>
            </button>
            <button id="viewOutline" class="toolbarButton" title="Voir Structure du document" onclick="PDFView.switchSidebarView('outline')" tabindex="2" data-l10n-id="outline" style="display:none;">
